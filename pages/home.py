...
class HomePage(QtWidgets.QFrame):
  ...
  def add_navbar(self):
    ...
    self.borrowed_items_button.clicked.connect(self.borrowed_items_button_clicked)
  ...
  def borrowed_items_button_clicked(self):
    self.borrowed_items_frame = BorrowedItems(self,self.user)
    self.stacked_frame.addWidget(self.borrowed_items_frame)
    self.stacked_frame.setCurrentWidget(self.borrowed_items_frame)