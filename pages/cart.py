...
from PyQt5.QtWidgets import QFrame, QVBoxLayout, QScrollArea, QHBoxLayout, QPushButton, QMessageBox
...
class CartList(QFrame):
  ...
  def add_request_button_clicked(self):
    ...
    request.add_request()
    self.cart.clear()
    QMessageBox.information(self, "Request Added", "Request has been added successfully")
