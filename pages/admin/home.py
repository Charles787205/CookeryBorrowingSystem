...
from .borrowed_request import RequestsView
...
class AdminHomePage(QtWidgets.QFrame):
  ...
  def on_borrow_request_clicked(self):
    request_view = RequestsView(self.stacked_layout)
    self.stacked_layout.addWidget(request_view)
    self.stacked_layout.setCurrentWidget(request_view)
