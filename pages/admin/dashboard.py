...
class Dashboard(QFrame):
  ...
  def add_most_borrowed_items(self):
    items = Item.get_most_borrowed_items()
    ...
    self.borrowed_items_label.setStyleSheet("font-size: 30px;color: white;")
    self.borrowed_items_label.setMaximumHeight(50)
    ...
    for item in items:
      ...
      self.borrowed_items_layout.addWidget(item_frame)
    
    self.borrowed_items_layout.addStretch()
